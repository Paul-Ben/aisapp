...
function showPromoteModal(id, name) { document.getElementById('promoteStudentId').value=id; document.getElementById('promoteStudentName').textContent=name; document.getElementById('promoteForm').action="{{ route('admin.students.bulk-promote') }}"; showModal('promoteModal'); }
function showDemoteModal(id, name) { document.getElementById('demoteStudentId').value=id; document.getElementById('demoteStudentName').textContent=name; document.getElementById('demoteForm').action="{{ route('admin.students.bulk-demote') }}"; showModal('demoteModal'); }
