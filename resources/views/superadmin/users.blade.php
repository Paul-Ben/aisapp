    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <h2 class="card-title"><i class="fas fa-users-cog me-2"></i>User Management</h2>
                    <p class="card-text">Manage all system users, assign roles, and control access.</p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <button class="btn btn-info" onclick="editUser({{ $user }})" title="Edit">
            ...
            <form action="{{ route('superadmin.users.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="add_is_active" name="is_active" checked value="1">
